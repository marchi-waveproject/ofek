...
export default class ShirTower extends Component {
  ...
  constructor(props) {
    ...
    let migrashimFilter =
      this.props.pageData.fullMigrashData.allSortedData.filter(function (desc) {
        return (
          desc.migrash.title ===
          props.pageData.fullMigrashData.allSortedData[0].migrash.title
        );
      });
      ...
      <div className="BeitShemesh BlueWave">
        <header className="topheader">
          ...
          <SearchBar
            ...
            Migrashim={this.props.pageData.fullMigrashData}
            {...this.props}
        ...
        <section className="section1">
          <Section1
            page={page}
            gallery={this.props.pageData.galleryTop}
            mobile={false}
          />
        </section>
        ...
        <section className="MapsPictures">
          <MapsPictures
            page={page}
            gallery={this.props.pageData.galleryMapsPictures}
          />
        </section>
        ...
        {false && (
          <Fragment>
            ...
            <section className="Prices">
              ...
              <Search
                currentState={this.state}
                Migrashim={this.state.migrashim}
              />
            </section>
            ...
            <section className="DeppartmentFile">
              <div className="buidingsFiles">
                <Container maxWidth="lg">
                  <h3>
                    ביניין: {this.state.buildingData.title} -{" "}
                    <small> ({this.state.buildingData.migrash_name})</small>
                  </h3>
                  ...
                  <div className="form-group changeBuildSelect">
                    <select
                      ...
                      name="building"
                      value={this.state.buildingTitle}
              ...
              <Container maxWidth="lg">
                ...
                <div className="allFiles">
                  {doccumentsFiles.map((files) => (
                    <a
                      key={files.id}
                      href={ConstantsNames.files + files.file}
