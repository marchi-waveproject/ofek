    ...
    render() {
        ...
        return (
            <React.Fragment>
                        ...
                        <div className='pictures'>
                            {
                                ...
                                <div className="item" key={item.data.id}  onClick ={ () => this.showHidepopUpText(item.data.image_big) }>
                                    <APPIpic  showclass="mainPic" pic={item} mobile={this.props.mobile} />
                                    <div className="hover">
                                        {item.data.alt}
                ...
                {this.state.popUpText_View ? <PopupPicture hidePopUp={this.hidePopUp} pageData={page} show={true} message={this.state.popUpText_Message} /> : false }
