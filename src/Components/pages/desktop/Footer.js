            ...
            <div className="footer-wrapper">
                <footer className="site-footer" role="contentinfo">
                    ...
                    {/* <section aria-label={site.settings.form_title} className='formSec' style={{backgroundImage: "url(" + Background + ")" }} >
                        <TextToHtml text={site.settings.form_title} format="h2"/>
                        
                        <FormConnector aria-label={site.settings.form_title} pageData={this.props} infoSite={this.props.info} showProjects={true} />
                    </section> */}
